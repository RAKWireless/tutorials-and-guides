...
#ifndef LORAWAN_CODE_H
#define LORAWAN_CODE_H
...
bool not_LoRa_connection = false;  // Flag to show a failure in the connection
...
uint8_t nodeDeviceEUI[8] = {0x60, 0x81, 0xF9, 0x82, 0x2D, 0x2A, 0x21, 0xC2};
uint8_t nodeAppEUI[8] = {0x00, 0x81, 0xF9, 0xA7, 0x34, 0x30, 0xE3, 0x3A};
uint8_t nodeAppKey[16] = {0x63, 0x39, 0xC1, 0xB1, 0xD5, 0x86, 0x2A, 0x81, 0x51, 0xEF, 0x0B, 0x58, 0xF6, 0x6B, 0xA9, 0xDE};
// ABP keys
...
static void lorawan_join_failed_handler(void)
{
  ...
  Serial.println("Trying to send using Blues");
